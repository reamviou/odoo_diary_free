...
class VitouDiaryStatus(models.Model):
     _name = 'vitoudiary.status'
     _inherit = ['mail.thread']
     _description = 'Status'
     _sql_constraints = [
          ('name_unique', 'unique(name)', "Status is duplicated!"),
     ]


     #reference = fields.Char(string="Reference", default='New')
     name = fields.Char(string="Status", required =True, tracking=True)
